...
def test_authored_runtime_bindings_match_canonical_source_hashes():
    ...
    assert {b['scene_id'] for b in cat['scenes']}=={'01-M01','01-M02','01-M03','01-M04','01-M05','01-M06','01-M07','02-M01','02-M02','02-M03','02-M04','02-M05','02-M06','03-M01','03-M02','03-M03','03-M04','03-M05','04-M01','04-M02','04-M03','04-M04','04-M05','04-M06','05-M01','05-M02','05-M03','05-M04','05-M05','06-M01','06-M02','06-M03'}|{'08-M03'}
    for b in cat['scenes']:
        ...
        assert b['physical_world_binding_status']==('PLAYABLE' if b['scene_id'] in {'01-M01','01-M02','01-M03','01-M04','01-M05','01-M06','01-M07','02-M01','02-M02','02-M03','02-M04','02-M05','02-M06','03-M01','03-M02','03-M03','03-M04','03-M05','04-M01','04-M02','04-M03','04-M04','04-M05','04-M06','05-M01','05-M02','05-M03','05-M04','05-M05','06-M01','06-M02','06-M03'} else 'NOT_IMPLEMENTED')
...
def test_runtime_foundation_marks_first_thirty_two_playable():
    manifest=load('world_manifest.json')
    assert sum(s['game_implementation_status']=='IMPLEMENTED' for s in manifest['scenes'])==32
    assert len(load('scene_bindings_v1.json')['scenes'])==33
