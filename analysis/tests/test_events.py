...
def test_solo_npc_events_are_not_player_qualifiers():
    ...
    assert all(e['npc_card_action_replay_status']=='NOT_IMPLEMENTED' for e in npc)
...
def test_extra_npc_matches_from_the_original_script_do_not_force_player_record():
    ...
    assert all(e['npc_card_action_replay_status']=='NOT_IMPLEMENTED' for e in new.values()) and not any(e['national_qualifier'] for e in new.values())
