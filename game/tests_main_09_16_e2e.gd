...
func run_suite() -> void:
	...
	print("M09-16 STEP: river approach")
	await reach("K1")
	await reach("K2")
	print("M09-16 STEP: 02-M02")
	open_current("02-M02")
